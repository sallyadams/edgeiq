...
const en: TranslationKeys = {
  ...
  landing: {
    ...
    freeAccessLine: "Free access · No commitment · Upgrade anytime",
    ...
    ctaTitle: "Your edge starts today.",
    ctaSubtitle: "Join thousands of traders who use EdgeIQ to stay ahead of the market.",
...
const fr: TranslationKeys = {
  ...
  landing: {
    ...
    freeAccessLine: "Accès gratuit · Sans engagement · Mise à niveau à tout moment",
    ...
    ctaTitle: "Votre avantage commence aujourd'hui.",
    ctaSubtitle: "Rejoignez des milliers de traders qui utilisent EdgeIQ pour garder une longueur d'avance.",
...
const de: TranslationKeys = {
  ...
  landing: {
    ...
    freeAccessLine: "Kostenloser Zugang · Keine Verpflichtung · Jederzeit upgraden",
    ...
    ctaTitle: "Ihr Vorteil beginnt heute.",
    ctaSubtitle: "Schließen Sie sich Tausenden von Tradern an, die EdgeIQ nutzen, um dem Markt voraus zu sein.",
...
const es: TranslationKeys = {
  ...
  landing: {
    ...
    freeAccessLine: "Acceso gratuito · Sin compromiso · Mejora cuando quieras",
    ...
    ctaTitle: "Tu ventaja empieza hoy.",
    ctaSubtitle: "Únete a miles de traders que usan EdgeIQ para ir por delante del mercado.",
...
const nl: TranslationKeys = {
  ...
  landing: {
    ...
    freeAccessLine: "Gratis toegang · Geen verplichting · Altijd upgraden",
    ...
    ctaTitle: "Jouw voordeel begint vandaag.",
    ctaSubtitle: "Sluit je aan bij duizenden traders die EdgeIQ gebruiken om voor te blijven op de markt.",
